...
function main() {
    ...
    try {
      if (!SHEET_URL) {
        Logger.log("Please enter your Google Sheet URL on line 4. \nYou can create a copy of the template sheet from: https://docs.google.com/spreadsheets/d/1TRuMopr2CIiy7vUPWMAPfr1xn1R6xZ3Zm_jPYKv6Jp4/copy");
        return;
      }
      ss = SpreadsheetApp.openByUrl(SHEET_URL);
    } catch (e) {
      Logger.log("Error accessing spreadsheet. Please check that you've entered a valid Google Sheet URL on line 4 and that you have access to it.");
      return;
    }
...
// remember to add the SHEET_URL at the top of the code the first time you use this
